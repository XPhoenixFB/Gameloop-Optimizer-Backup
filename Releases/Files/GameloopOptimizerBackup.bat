...
set "current_version=1.6"  :: Versión actual de la Herramienta
set "version_url=https://github.com/XPhoenixFB/Gameloop-Optimizer-Backup/raw/version.txt"
set "update_url=https://github.com/XPhoenixFB/Gameloop-Optimizer-Backup/raw/Releases/Files/GameloopOptimizerBackup.bat"
set "temp_version_file=%temp%\version.txt"
set "temp_update_file=%temp%\GameloopOptimizerBackup.bat"
...
title Gameloop Optimizer Backup v1.6 by XPhoenix
